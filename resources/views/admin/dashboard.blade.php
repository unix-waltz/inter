    ...
    <div id="crud-modal" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <!-- Modal body -->
                <form class="p-4 md:p-5" action="/new/product" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <select id="category" name="product_category"
                                ...
                                <option selected="food">Food</option>
                        ...
                        <div class="col-span-2">
                            <label for="description"
                                ...
                                Description</label>
                            <textarea name="product_description" id="description" rows="4"
            ...
            <div class="mx-auto grid grid-cols-4 gap-3">
                @foreach ($productall as $p)
                    <div
                        ...
                        <a href="#">
                            <img class="pb-2 rounded-sm" src="{{ asset('storage/' . $p->product_thumbnail) }}"
                                alt="product image" />
                        </a>
                        <div class="px-5 pb-5">
                            <a href="#">
                            ...
                            <div class="flex items-center justify-between">
                                <span
                                    class="text-3xl font-bold text-gray-900 dark:text-white">${{ $p->product_price }}</span>
