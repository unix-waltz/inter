...
<form class="max-w-sm mx-auto mt-10" method="post">
    @csrf
    @method('POST')
    <h1 class="font-bold text-3xl">Login</h1><br>
    <div class="mb-5">
  ...
  <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>&nbsp;&nbsp;&nbsp; <a href="/auth/register" class="text-blue-700">New Member? register here</a>
</form>
